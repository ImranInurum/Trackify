class AppImages {
  ...
  static const String activateContactSticker = "$images/scanner_image.png";

  static const String exploreApp = "$images/explore_app_image.jpg";

  static const String arrowUpIcon = "$icons/arrowUpIcon.png";

  static const String darkMapStyle = "$images/darkStyle.png";
  static const String lightMapStyle = "$images/lightStyle.png";
