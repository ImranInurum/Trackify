...
class RidesStatisticsScreen extends StatefulWidget {
  const RidesStatisticsScreen({super.key});

  @override
  State<RidesStatisticsScreen> createState() => _RidesStatisticsScreenState();
}

class _RidesStatisticsScreenState extends State<RidesStatisticsScreen> {

  @override
  void initState() {
    context.read<FeatureCubit>().loadRideItems();
    super.initState();
  }
