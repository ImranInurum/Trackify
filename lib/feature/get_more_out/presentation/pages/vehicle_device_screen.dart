...
class VehicleDeviceScreen extends StatefulWidget {
  const VehicleDeviceScreen({super.key});

  @override
  State<VehicleDeviceScreen> createState() => _VehicleDeviceScreenState();
}

class _VehicleDeviceScreenState extends State<VehicleDeviceScreen> {

  @override
  void initState() {
    context.read<FeatureCubit>().loadDeviceItems();
    super.initState();
  }
