...
class MyProfileScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Icon(Icons.two_wheeler, size: 50, color: Colors.blueAccent),
  ...
  Widget _buildFeatureList(BuildContext context) {
    ...
    final features = [
      ...
      {'title': l10n.geoFence, 'icon': Icons.my_location, 'color': Colors.blueAccent},
      {'title': l10n.overspeedAlert, 'icon': Icons.speed, 'color': Colors.purpleAccent},
      {'title': l10n.fuelLogs, 'icon': Icons.local_gas_station, 'color': Colors.green},
    ...
    final reviews = [
      {
        'name': 'Alex Johnson',
        'rating': 5,
        'comment': 'Amazing device! It saved my bike from getting stolen last week.',
      },
      {
        'name': 'Sarah Mitchell',
        'rating': 4,
        'comment': 'The geo-fence feature is exactly what I needed for peace of mind.',
      },
      {
        'name': 'David Chen',
        'rating': 5,
