...
class RefuelHistoryTabView extends StatefulWidget {
  ...
  @override
  State<RefuelHistoryTabView> createState() =>
      _RefuelHistoryTabViewState();
}

class _RefuelHistoryTabViewState
    extends State<RefuelHistoryTabView> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<
      ...
      builder: (context, refuelState) {
        ...
        if (refuelState
        is RefuelHistoryLoaded) {

          final fuelState = context.watch<FuelLogsCubit>().state;
          final totalFuelAdded = fuelState is FuelLogsLoaded ? fuelState.totalFuelAdded : "0";
          final totalSpendings = fuelState is FuelLogsLoaded ? fuelState.totalSpendings : "0";
          final averageMileage = fuelState is FuelLogsLoaded ? fuelState.averageMileage : "0";
